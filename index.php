...
<h4 class="mb-2"><strong>▀▄▀▄▀▄  ☆  ★  𝕲𝖗𝖆𝖈𝖎𝖊 𝕾𝖙𝖗𝖎𝖕𝖊 ☆  ★    ▀▄▀▄▀▄</strong></h4>
<div class="form-group">
PURCHASED: <span class="badge badge-success charge">0</span>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body text-center">
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR MF LIST HERE"></textarea>
					...
					<button class="btn btn-stop btn-glow btn-bg-x-black text-darkgray" style="width: 49%; float: right;" disabled><i class="fa fa-stop"></i>STOP</button>
                        ...
                        <div class="spotify-embed">
                             <iframe style="border-radius:10px" src="https://open.spotify.com/embed/track/5E30LdtzQTGqRvNd7l6kG5?utm_source=generator" width="400" height="90"  
			...
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-check-circle text-success"></i> PURCHASED <span class="badge badge-success charge">0</span></h4>					
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-check text-success"></i> LIVE <span class="badge badge-success aprovadas">0</span></h4>					
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title mb-1"><i class="fa fa-times text-danger"></i> DEAD <span class="badge badge-danger reprovadas">0</span></h4>		
...
Swal.fire({ title: "WARNING", text: "owned by graciehams", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
